...
- [Name the three ways to declare a variable](#variable-declaration) - Three ways to declare a variable in JS is through const, var, or let.
- [Which of the three variable declarations should you avoid and why?](#avoid-var) - The one to avoid is var because it is an old style declaration & may cause conflicts 
- [What rules should you follow when naming variables?](https://javascript.info/variables#variable-naming) - When you declare variables, you should agree on a consistent name for subjects & objects, use camelcase, & avoid abbrevations & symbols while also not starting with numbers
- [What happens when you add numbers and strings together?](https://javascript.info/operators#string-concatenation-with-binary) - when you add numbers & strings together, the numbers will be converted to strings unless the first two pairs are numbers for which it will be added normally first then concatenated if the next number is a string
- [How does the Modulo (%), or Remainder, operator work?](https://javascript.info/operators#remainder) - Remainder generally works by dividing a number & giving its remainder after division
- [Explain the difference between `==` and `===`.](https://www.w3schools.com/js/js_numbers.asp) - == is an equality operator that is less strict than ===, since the fomrmer not always check for data type, while the latter does
- [When would you receive a `NaN` result?](https://www.w3schools.com/js/js_numbers.asp) - You receive a NaN result when you add a alphabetical or symbolic string with a number, or you declare a number by itself
- [How do you increment and decrement a number?](https://javascript.info/operators#increment-decrement) - You can increment a number using ++ by prefixing or postfixing, the former before the number, the latter after the number
- [Explain the difference between prefixing and postfixing increment/decrement operators.](https://javascript.info/operators#increment-decrement) - Prefixing a number will output the modified number directly, while postfixing will do it shortly after
- [What is operator precedence and how is it handled in JS?](https://javascript.info/operators#operator-precedence) - Just like traditional PEMDAS, except there is an exception with Unary operators which hold the highest presedence
- [How do you access developer tools and the console?](#access-devTools-console) - F12
- [How do you log information to the console?](#console-log) - console.log
- [What does unary plus operator do to string representations of integers? eg. +"10"](https://javascript.info/operators#numeric-conversion-unary) - It converts them to actual numbers 
