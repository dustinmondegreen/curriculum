...
- [What are functions useful for?](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Functions) - Functions are useful for duplicating blocks of code to any section of a program when needed without copying the whole code again, allowing modularity. 
- [How do you invoke a function?](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Functions#invoking_functions) - with the keyword function, then function name with parameters
- [What are anonymous functions?](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Functions#anonymous_functions_and_arrow_functions) - Anonymous functions are functions without any names, that are usually used in arrow functions or function expressions 
- [What is function scope?](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Functions#function_scope_and_conflicts) - function scope is the boundaries that a variable can be called within a function
- [What are return values?](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Building_blocks/Return_values) - return values are the values that a function returns when a return keyword is sent that will end the function
- [What are arrow functions?](https://javascript.info/arrow-functions-basics) - arrow functions are an alternative way to create function expressions through the use of arrows that return a value
