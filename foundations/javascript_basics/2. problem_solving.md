...
- 	•	The 3 stages in problem solving involve understanding the problem to plan, applying pseudocode, & using divide & conquer
- [Why is it important to clearly understand the problem first?](#important-understand-problem)
- 	•	It is important to clearly understand the problem first to understand what needs to be done. It will help in making it clear what sub-problems there are that should be tackled & the overall point of the program
- [What can you do to help get a clearer understanding of the problem?](#help-understand-problem)
- 	•	You can write in plain English, use diagrams like flowcharts, or use the rubber duck method (not recommended)
- [What are some of the things you should do in the planning stage of the problem solving process?](#planning-stage)
- 	•	In the planning stage of the problem solving process, you should ask general questions related to the main problem & be given a general answer
- [What is an algorithm?](#algorithm)
- 	•	An algorithm is a set of instructions that are used to solve a particular program within a program
- [What is pseudocode?](#pseudo)
- 	•	Pseudocode is code that is used to be a bridge between flowcharts & actual code where the logic of the code is written in plain English but as if it were actual code 
- [What are the advantages of breaking a problem down and solving the smaller problems?](#breaking-problem)
- 	•	The advantage to divide & conquer is the fact that it allows scalability of the program, which gives a better chance for the program to be debugged easily despite the complexity of the project. 
