...
- [Why is it important to write clean code?](#Introduction)
	⁃	Clean code is important because we need it to be readable in case any modifications are needed, but the people who made the code aren’t available. It also allows us to write code that its easily understandable and can easily be debugged. Clean code also reduces stress and complications through miscommunication and typical errors. 
- [Name 5 clean code principles previously mentioned](https://onextrapixel.com/10-principles-for-keeping-your-programming-code-clean/)
  ⁃	Revise your logic before coding 
	⁃	Try to code without comments that explain how the code works 
	⁃	Use comments to explain only why the code works 
	⁃	Avoid extremely large functions; modularize. 
	⁃	Use naming standards to functions and variables 
- [What is the difference between good comments and bad comments?](https://onextrapixel.com/10-principles-for-keeping-your-programming-code-clean/)
  ⁃	A bad comment will be a substitute to explaining how & why the code works, while also being too long, while a good comment explains only why code works in a concise way 
